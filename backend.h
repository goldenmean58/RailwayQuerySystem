...
public:
    ...
    Route *next;
    Route(const char *trainName, const char *srcName, const char *destName, int startTime, int arriveTime, int fee);
    Route();
};
...
public:
    SubResult();
    SubResult(const char *trainName, const char *srcName, const char *destName, int startTime,int arriveTime,int fee);
};
...
public:
    Result();
    ~Result();
    void addSubResult(const char *trainName, const char *srcName, const char *destName, int startTime, int arriveTime, int fee, enum Condition queryCondition);
